class Techscan < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "adbb5f7468717be54c623333fa809d3a0616e84310c0a0f827a485824e48c243"
    else
      url "https://github.com/kimulaco/techscan/releases/download/v#{version}/techscan-darwin-x64.tar.gz"
      sha256 "7a760b3c3bd0b9849df898450515a2bbd888b20c670ebf5cbe289edadb185238"
    end
  end

  on_linux do
    url "https://github.com/kimulaco/techscan/releases/download/v#{version}/techscan-linux-x64.tar.gz"
    sha256 "0358c7465422357d9dd98017b00068703409ee15966511d5711ebbe049b1a2b1"
  end
